      ...
      <el-tooltip placement="top">
        <template #content>
          <div class="flex flex-col w-10 items-center">
            <el-slider class="!py-4" height="150px" v-model="SongStore.volume" vertical :show-tooltip="false">
            </el-slider>
            {{ SongStore.volume + "%" }}
          </div>
        </template>
        <div class="el-dropdown-link">
          <svg t="1729521473313" class="icon" viewBox="0 0 1024 1024" version="1.1"
               xmlns="http://www.w3.org/2000/svg" p-id="4278" width="28" height="28">
            <path
